...
```
_[GPT.py line 59-90](https://github.com/FangYzzz/manigpt/blob/main/src/grasp_publisher/grasp_publisher/GPT.py)_
...
### 3.1.3 Grasp Object and Grasp Part Detection & Point Cloud Generating
...
def prediction(module, variables, input_image, tokenized_queries, text_queries, crop, cx_=0, cy_=0, original_padding_image=None, width_ =0, height_=0):
    ...
    for score, box, label in zip(scores, boxes, labels):
        ...
        if crop == True:                       
            ...
            cropped_image.save(os.path.join('/home/yuan/mani_gpt/src/grasp_publisher/grasp_publisher/camera_capture/lab/cropped_image0.png'))    #
            ...
            plt.savefig(os.path.join('/home/yuan/mani_gpt/src/grasp_publisher/grasp_publisher/camera_capture/lab/cropped_image0_1.png'))             # 
            return cx, cy, w, h

```
_[owl_vit.py line 138-267](https://github.com/FangYzzz/manigpt/blob/main/src/grasp_publisher/grasp_publisher/owl_vit.py)_
...
```
_[point_cloud_grasp_sample.py line 16-68](https://github.com/FangYzzz/manigpt/blob/main/src/grasp_publisher/grasp_publisher/point_cloud_grasp_sample.py)_
...
```
_[point_cloud_grasp_sample.py line 100-142](https://github.com/FangYzzz/manigpt/blob/main/src/grasp_publisher/grasp_publisher/point_cloud_grasp_sample.py)_
...
_Cropped Pepper_
![Desktop View](/assets/img/cropped_teapot.png) 
_Cropped Teapot_
![Desktop View](/assets/img/cropped_teapot_11.png) 
_Handle of Teapot_
